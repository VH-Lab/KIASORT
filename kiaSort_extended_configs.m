...
extra_cfg = struct(...
    ...
    'qualityCheckLength',       3, ...              % Duration (s) for quality check (code multiplies by fs)
    ...
    'parallelSort',             false ...            % Stage-3 (sortData) per-channel parallelism (experimental; serial when false)
    );
